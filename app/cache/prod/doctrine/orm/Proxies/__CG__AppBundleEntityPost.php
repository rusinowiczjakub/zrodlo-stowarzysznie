...
class Post extends \AppBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'header', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'sign', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'images'];
        }
