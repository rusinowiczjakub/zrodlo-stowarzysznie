...
class __TwigTemplate_dc6137e30637ed98456073ad59363f466cc0703a35c3576143d07a72002238cf extends Twig_Template
{
...
";
    ...
    public function block_sonata_type_datetime_picker_widget_html($context, array $blocks = array())
    {
        ...
        if (($context["datepicker_use_button"] ?? null)) {
            ...
            if ( !twig_get_attribute($this->env, $this->getSourceContext(), ($context["dp_options"] ?? null), "pickDate", array(), "array")) {
                echo "timepicker";
            }
            echo "' id='dtp_";
            echo twig_escape_filter($this->env, ($context["id"] ?? null), "html", null, true);
    ...
    {
        return new Twig_Source("", "SonataCoreBundle:Form:datepicker.html.twig", "/home/kuba/Workspace/vendor/sonata-project/core-bundle/src/Resources/views/Form/datepicker.html.twig");
    }
}
