...
class __TwigTemplate_9207d981e26949b9666a767773ae9038b6c27b738fc8b0579081b7e0beacd1e0 extends Twig_Template
{
...
";
    ...
    public function block_header($context, array $blocks = array())
    {
        // line 11
        echo "    <h1>";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["post"] ?? null), "header", array()), "html", null, true);
        echo "</h1>
";
    }
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        // line 22
        echo "                <p>";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["post"] ?? null), "sign", array()), "html", null, true);
        echo "</p>
            </div>
        </div>
        <div class=\"gallery\">
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["post"] ?? null), "images", array()));
        foreach ($context['_seq'] as $context["_key"] => $context["image"]) {
            // line 32
            echo "                    <a href=";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl(("uploads/" . $this->getAttribute($context["image"], "name", array()))), "html", null, true);
...
";
    ...
    {
        return new Twig_Source("", ":front:single_post.html.twig", "/home/kuba/zrodlo/app/Resources/views/front/single_post.html.twig");
    }
}
