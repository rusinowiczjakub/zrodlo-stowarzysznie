...
class __TwigTemplate_9ce3b8dd5f16b65b82e649dff5fb5eceba65e405c8c732a60aacc5df2f359565 extends Twig_Template
{
    ...
    public function block_multiple_file_upload_widget($context, array $blocks = array())
    {
        // line 3
        echo "    ";
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "admin", array()), "subject", array()), "id", array())) {
            // line 4
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["form"] ?? null), "vars", array()), "allowed_extensions_filter", array()), "html", null, true);
            echo "';";
            ob_start();
            // line 14
            echo "             ";
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["form"] ?? null), "vars", array()), "allow_images", array()), "html", null, true);
            echo "';";
            ob_start();
            // line 15
            echo "             ";
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["form"] ?? null), "vars", array()), "allow_files", array()), "html", null, true);
            echo "';";
            ob_start();
            // line 16
            echo "             ";
            echo trim(preg_replace('/>\s+</', '><', ob_get_clean()));
            echo "ctrl.entity='";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "admin", array()), "classnameLabel", array()), "html", null, true);
            echo "';";
            ob_start();
            // line 17
            echo "             ";
            echo trim(preg_replace('/>\s+</', '><', ob_get_clean()));
            echo "ctrl.id='";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "admin", array()), "subject", array()), "id", array()), "html", null, true);
            echo "';";
            ob_start();
            // line 18
            echo "             ";
            echo trim(preg_replace('/>\s+</', '><', ob_get_clean()));
            echo "ctrl.field='";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "field_description", array()), "fieldName", array()), "html", null, true);
            echo "';";
            ob_start();
            // line 19
            echo "             ";
            if ($this->getAttribute($this->getAttribute(($context["form"] ?? null), "vars", array()), "allow_files", array())) {
                // line 20
            ...
            // line 22
            echo "             ";
            if ( !$this->getAttribute($this->getAttribute(($context["form"] ?? null), "vars", array()), "read_only", array())) {
                // line 23
        ...
        >
            ...
            if ( !$this->getAttribute($this->getAttribute(($context["form"] ?? null), "vars", array()), "read_only", array())) {
                ...
                // line 97
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute(($context["form"] ?? null), "vars", array()), "allowed_extensions", array()));
                $context['loop'] = array(
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
