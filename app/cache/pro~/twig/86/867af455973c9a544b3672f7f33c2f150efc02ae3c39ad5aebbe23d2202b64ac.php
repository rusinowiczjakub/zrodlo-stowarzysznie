...
class __TwigTemplate_2f6f8cb28682d4769ed7e09e1f7347170e4550c36f67e80f05bc4b00b7c321aa extends Twig_Template
{
    ...
    <div class=\"dropdown-menu multi-column dropdown-add\"
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            // line 22
            echo "            ";
            $context["display"] = (twig_test_empty($this->getAttribute($context["group"], "roles", array())) || $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "adminPool", array()), "getOption", array(0 => "role_admin"), "method")));
            // line 23
            echo "            ";
            $context['_parent'] = $context;
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:Core:add_block.html.twig", "/home/kuba/zrodlo/vendor/sonata-project/admin-bundle/src/Resources/views/Core/add_block.html.twig");
    }
}
