...
class __TwigTemplate_d9b0bf97b955a2d33b3fa1ee0a88d4772bfe998fd38d2992120bbbf1f1375691 extends Twig_Template
{
...
($context["id"] ?? null), "subclass" => $this->getAttribute($this->getAttribute(            // line 305
($context["sonata_admin"] ?? null), "admin", array()), "getActiveSubclassCode", array(), "method"), "objectId" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 306
($context["sonata_admin"] ?? null), "admin", array()), "root", array()), "id", array(0 => $this->getAttribute($this->getAttribute($this->getAttribute(($context["sonata_admin"] ?? null), "admin", array()), "root", array()), "subject", array())), "method"), "uniqid" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 307
($context["sonata_admin"] ?? null), "admin", array()), "root", array()), "uniqid", array()), "code" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 308
    ...
    ";
        ...
        jQuery('#";
            ...
            jQuery.ajax({
                ...
                url: '";
            // line 465
            echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("sonata_admin_short_object_information", array("objectId" => "OBJECT_ID", "uniqid" => $this->getAttribute(            // line 467
($context["associationadmin"] ?? null), "uniqid", array()), "code" => $this->getAttribute(            // line 468
($context["associationadmin"] ?? null), "code", array()), "linkParameters" => $this->getAttribute($this->getAttribute($this->getAttribute(            // line 469
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:CRUD/Association:edit_many_script.html.twig", "/home/kuba/zrodlo/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/Association/edit_many_script.html.twig");
    }
}
