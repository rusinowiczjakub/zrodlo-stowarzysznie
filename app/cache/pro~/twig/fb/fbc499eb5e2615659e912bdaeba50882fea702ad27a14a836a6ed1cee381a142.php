...
class __TwigTemplate_a8e9f70ca7071c9dae2cc38dee7e26f60656500e51aadc131dee4443eb6a0e38 extends Twig_Template
{
            ...
            <div class=\"";
                ...
                <div class=\"box-header\">
                    <h4 class=\"box-title\">
                        ";
                    // line 11
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans($this->getAttribute(($context["form_group"] ?? null), "label", array()), array(), (($this->getAttribute(($context["form_group"] ?? null), "translation_domain", array())) ? ($this->getAttribute(($context["form_group"] ?? null), "translation_domain", array())) : ($this->getAttribute(($context["admin"] ?? null), "translationDomain", array())))), "html", null, true);
                    echo "
                    </h4>
                </div>
                <div class=\"box-body\">
                    ...
                    if ($this->getAttribute(($context["form_group"] ?? null), "description", array())) {
                        // line 17
                        echo "                            <p>";
                        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans($this->getAttribute(($context["form_group"] ?? null), "description", array()), array(), (($this->getAttribute(($context["form_group"] ?? null), "translation_domain", array())) ? ($this->getAttribute(($context["form_group"] ?? null), "translation_domain", array())) : ($this->getAttribute(($context["admin"] ?? null), "translationDomain", array())))), "html", null, true);
                        echo "</p>
                        ";
                    }
                    // line 19
